<template>
  <div class="mt-10 bg-primary">
    <div class="relative bg-white py-10 md:py-20"></div>

    <!-- footer -->
    <div class="mx-auto w-full container mt-10 md:py-10 px-4">
      <div
      ...
      >
          ...
          <div class="text-[18px] font-medium text-white">
            <router-link to="/"
              ><div class="flex gap-2 items-center">
                ...
                <h1 class="text-xl font-extrabold text-white">ISZIFY</h1>
              </div></router-link
            >
          </div>
          <p class="mt-[18px] text-sm font-normal text-white">
        ...
        <div
          class="mt-6 flex w-full flex-col justify-center text-white sm:flex-row md:mt-0 md:max-w-[341px]"
        >
          <div class="">
            <p
              class="uppercase text-white font-bold text-base md:text-lg leading-normal"
            >
              product links
            </p>
            <ul>
              <li class="mt-[15px]">
                <router-link
                  class="font-inter text-sm font-normal hover:font-semibold"
                  to="/"
                  >Home</router-link
                >
              </li>
          ...
          <div class="mt-[23px] flex">
            ...
            <div class="ml-[18px]">
              <a
                ...
                class="font-Inter text-sm font-medium text-[#fff]"
                >help@lorem.com</a
              >
