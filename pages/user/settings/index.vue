<template>
  <section>
    <div class="mx-4 min-h-screen max-w-screen-xl sm:mx-8 xl:mx-auto pt-20">
      <div class="">
        <div class="overflow-hidden rounded-xl sm:px-8">
          <div class="pt-4">
          ...
          >
            ...
            <button
              class="inline-flex text-sm font-semibold text-info underline decoration-2"
            >
              Change
            </button>
          </div>
          ...
          <div class="space-y-3">
            ...
            <!-- <p class="mt-2">
              ...
              <a
                class="text-sm font-semibold text-info underline decoration-2"
                href="#"
                >Recover Account</a
              >
            </p> -->
            <button
              class="mt-6 rounded-lg bg-info-tint px-4 py-2 text-info hover:text-white hover:bg-info"
            >
              Save Password
            </button>
          </div>
