    ...
    <div class="max-w-6xl mx-8 md:mx-10 lg:mx-20 xl:mx-auto">
      ...
      >
        <div class="mb-12 space-y-5 md:mb-16 md:text-center">
          <div
            class="inline-block px-3 py-1 text-sm font-semibold text-info rounded-lg md:text-center bg-opacity-60 hover:cursor-pointer hover:bg-opacity-40"
          >
            Words from Others
          </div>
          <h1
            class="mb-5 text-3xl font-semibold text-success md:text-center md:text-5xl"
          >
            It's not just us.
          </h1>
          <p class="text-xl text-accent md:text-center md:text-2xl">
        ...
        <ul class="space-y-8">
          <li class="text-sm leading-6">
            <div class="relative group">
              <div
                class="absolute transition rounded-lg opacity-25 -inset-1 bg-gradient-to-r from-green-500 to-green-100 blur duration-400 group-hover:opacity-100 group-hover:duration-200"
              ></div>
              <a href="https://twitter.com/kanyewest" class="cursor-pointer">
                ...
                >
                  ...
                  <p class="leading-normal text-md">Find God.</p>
                </div>
              </a>
            </div>
          </li>
